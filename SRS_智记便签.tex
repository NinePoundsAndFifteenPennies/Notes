...
\begin{document}
	...
	\begin{titlepage}
		...
		% --- 2号宋体 (22pt) ---
		% 我们用 \cjkfontfamily{songti} 临时切换到宋体
		{\cjkfontfamily{songti} \fontsize{22}{26}\selectfont 计算机科学与技术学院}\\[2cm]
		...
		\begin{center}
			...
			{\cjkfontfamily{songti} \fontsize{14}{18}\selectfont
				\begin{tabular}{l@{\hspace{1cm}}l}
					...
					% --- 其他信息 ---
					\makebox[4cm][s]{人员分工：} & \makebox[8cm][l]{潘铮负责画图与组织SRS，季凯阳负责具体内容编写} \\[1.2cm]
