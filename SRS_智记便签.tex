...
\begin{document}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}[scale=0.65, transform shape]
			...
			% ShareHelper类
			\node[draw, rectangle, minimum width=5cm, below of=converter, yshift=-3.5cm, align=left] (helper) {
				\textbf{ShareHelper} \\
				\rule{5cm}{0.4pt} \\
				-context: Context \\
				\rule{5cm}{0.4pt} \\
			...
			% FormatDialog类
			\node[draw, rectangle, minimum width=5cm, right of=converter, xshift=8cm, align=left] (dialog) {
				\textbf{FormatDialog} \\
				\rule{5cm}{0.4pt} \\
